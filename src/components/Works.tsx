      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          {projects.map((project, index) => (
            <motion.div
              key={index}
              className={`rounded-xl overflow-hidden hover-lift relative group perspective-card ${project.featured ? 'md:col-span-2 lg:col-span-1' : ''}`}
                ...
                <div className="aspect-video w-full overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-cyan-900/70 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="flex gap-4">
                      <a href={project.link} className="p-3 bg-black/50 rounded-full hover:bg-cyan-600/80 transition-colors duration-300">
                        <ExternalLink size={20} className="text-white" />
                      </a>
                      <a href="#" className="p-3 bg-black/50 rounded-full hover:bg-cyan-600/80 transition-colors duration-300">
